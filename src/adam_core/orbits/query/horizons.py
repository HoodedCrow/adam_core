...
def _parse_rotational_period_input_response(
    object_id: str, text: str
...
def query_rotational_period_inputs_from_horizons(
    object_id: str, stn: str, obs_times: pa.DoubleArray
) -> RotationalPeriodInput:
    ...
    while start_chunk < len(obs_times):
        ...
        resp = sess.get(API_URL, params=params, timeout=10)
